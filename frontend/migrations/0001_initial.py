# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-03-31 19:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(default='a4c96f47-ee06-44f4-940f-9ccfc10f37b8', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('color', models.CharField(default='default', max_length=60)),
            ],
        ),
        migrations.CreateModel(
            name='ContactCo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('etnia', models.CharField(default='default', max_length=40)),
            ],
        ),
        migrations.CreateModel(
            name='EventoCo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('destino', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='siguiendo', to=settings.AUTH_USER_MODEL)),
                ('origen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seguidores', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TipoArte',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_arte', models.ForeignKey(db_column='Idtalento', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tipo_arte', to='frontend.TipoArte')),
                ('id_usuario', models.ForeignKey(db_column='Idusuario', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_arte', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdOn', models.DateTimeField(auto_now_add=True, verbose_name='created On')),
                ('modifiedOn', models.DateTimeField(auto_now=True, verbose_name='modified On')),
                ('id_genero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genero', to='frontend.GeneroArtistico')),
                ('id_usuario', models.ForeignKey(db_column='Idusuario', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_genero', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user',
            name='color_cabello',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='color_cabellos', to='frontend.Cabellos'),
        ),
        migrations.AddField(
            model_name='user',
            name='color_ojos',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='color_ojos', to='frontend.Ojos'),
        ),
        migrations.AddField(
            model_name='user',
            name='etnia',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tipo_etnia', to='frontend.Etnia'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
